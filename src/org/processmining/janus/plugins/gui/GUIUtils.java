...
public class GUIUtils {
	...
	public static Color resolutionEventViolated = new Color(eventViolated.getRed(), eventViolated.getGreen(), eventViolated.getBlue(), 100);
	public static Color resolutionEventFulfilled = new Color(eventFulfilled.getRed(), eventFulfilled.getGreen(), eventFulfilled.getBlue(), 100);
//	public static Color resolutionEventConflict = eventConflict.darker();
